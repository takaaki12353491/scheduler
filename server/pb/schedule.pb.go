...
func (x *IndexRequest) GetMonth() int32 {
	if x != nil {
		return x.Month
	}
	return 0
...
var file_schedule_proto_rawDesc = []byte{
	...
	0x70, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x24, 0x0a, 0x0c, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x6d, 0x6f, 0x6e, 0x74, 0x68, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x6d, 0x6f, 0x6e, 0x74, 0x68, 0x22, 0x41, 0x0a, 0x0d, 0x49,
...
var file_schedule_proto_depIdxs = []int32{
	...
	0,  // 1: schedule.IndexResponse.schedules:type_name -> schedule.Schedule
	0,  // 2: schedule.ShowResponse.schedule:type_name -> schedule.Schedule
	11, // 3: schedule.CreateRequest.date:type_name -> google.protobuf.Timestamp
	0,  // 4: schedule.CreateResponse.schedule:type_name -> schedule.Schedule
	11, // 5: schedule.UpdateRequest.date:type_name -> google.protobuf.Timestamp
	0,  // 6: schedule.UpdateResponse.schedule:type_name -> schedule.Schedule
	1,  // 7: schedule.ScheduleService.index:input_type -> schedule.IndexRequest
	3,  // 8: schedule.ScheduleService.show:input_type -> schedule.ShowRequest
	5,  // 9: schedule.ScheduleService.create:input_type -> schedule.CreateRequest
	7,  // 10: schedule.ScheduleService.update:input_type -> schedule.UpdateRequest
	9,  // 11: schedule.ScheduleService.delete:input_type -> schedule.DeleteRequest
	2,  // 12: schedule.ScheduleService.index:output_type -> schedule.IndexResponse
	4,  // 13: schedule.ScheduleService.show:output_type -> schedule.ShowResponse
	6,  // 14: schedule.ScheduleService.create:output_type -> schedule.CreateResponse
	8,  // 15: schedule.ScheduleService.update:output_type -> schedule.UpdateResponse
	10, // 16: schedule.ScheduleService.delete:output_type -> schedule.DeleteResponse
